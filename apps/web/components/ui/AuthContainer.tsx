                ...
                <div className="flex flex-row ">
                  <div className="flex flex-row gap-1">
                    ...
                    <div className="flex flex-col">
                      ...
                      <Link onClick={() => { handleToggleNav(); window.localStorage.setItem("price-type", "0") }} href="/signup" className="flex-row text-md" >
                        {t("sign_up")}
                      </Link>
                    </div>
                  </div>
                    ...
                    <div className="flex-col hidden md:contents">
                      <div className="flex flex-row gap-1">
                        ...
                        <div className="flex flex-col">
                          ...
                          <Link href="/signup" className="flex-row text-xs" onClick={() => { window.localStorage.setItem("price-type", "0") }}>
                            {t("sign_up")}
                          </Link>
                        </div>
                      </div>{/*  */}
