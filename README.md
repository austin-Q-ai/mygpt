<!-- PROJECT LOGO -->
<p align="center">
  <a href="https://github.com/calcom/mygpt.fi">
   <img src="https://user-images.githubusercontent.com/8019099/210054112-5955e812-a76e-4160-9ddd-58f2c72f1cce.png" alt="Logo">
  </a>

  <h3 align="center">MyGPT.fi (formerly Calendso)</h3>

  <p align="center">
    The open-source Calendly alternative.
    <br />
    <a href="https://mygpt.fi"><strong>Learn more »</strong></a>
    <br />
    <br />
    <a href="https://go.mygpt.fi/discord">Discord</a>
    ·
    <a href="https://mygpt.fi">Website</a>
    ·
    <a href="https://github.com/calcom/mygpt.fi/issues">Issues</a>
    ·
    <a href="https://mygpt.fi/roadmap">Roadmap</a>
  </p>
</p>

<p align="center">
   <a href="https://go.mygpt.fi/discord"><img src="https://img.shields.io/badge/Discord-go.mygpt.fi%2Fdiscord-%234A154B" alt="Join MyGPT.fi Discord"></a>
   ...
   <a href="https://status.mygpt.fi"><img height="20px" src="https://betteruptime.com/status-badges/v1/monitor/a9kf.svg" alt="Uptime"></a>
   <a href="https://github.com/calcom/mygpt.fi/stargazers"><img src="https://img.shields.io/github/stars/calcom/mygpt.fi" alt="Github Stars"></a>
   ...
   <a href="https://github.com/calcom/mygpt.fi/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-AGPLv3-purple" alt="License"></a>
   <a href="https://github.com/calcom/mygpt.fi/pulse"><img src="https://img.shields.io/github/commit-activity/m/calcom/mygpt.fi" alt="Commits-per-month"></a>
   <a href="https://mygpt.fi/pricing"><img src="https://img.shields.io/badge/Pricing-Free-brightgreen" alt="Pricing"></a>
   <a href="https://jitsu.com?utm_source=github/calcom/mygpt.fi"><img src="https://img.shields.io/badge/Metrics_tracked_by-JITSU-AA00FF?logo=data:image/png;base64," alt="Jitsu Tracked"></a>
   ...
   <a href="https://github.com/calcom/mygpt.fi/issues?q=is:issue+is:open+label:%22%F0%9F%99%8B%F0%9F%8F%BB%E2%80%8D%E2%99%82%EF%B8%8Fhelp+wanted%22"><img src="https://img.shields.io/badge/Help%20Wanted-Contribute-blue"></a>
   <a href="https://mygpt.fi/figma"><img src="https://img.shields.io/badge/Figma-Design%20System-blueviolet"></a>
...
<img width="100%" alt="booking-screen" src="https://github.com/calcom/mygpt.fi/assets/8019099/407e727e-ff19-4ca4-bcae-049dca05cf02">
...
That's where MyGPT.fi comes in. Self-hosted or hosted by us. White-label by design. API-driven and ready to be deployed on your own domain. Full control of your events and data.

## Recognition

#### [Hacker News](https://news.ycombinator.com/from?site=mygpt.fi)
...
<a href="https://producthunt.com/posts/calendso?utm_source=badge-top-post-badge&utm_medium=badge&utm_souce=badge-calendso" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/top-post-badge.svg?post_id=291910&theme=light&period=monthly" alt="MyGPT.fi - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a> <a href="https://producthunt.com/posts/calendso?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-calendso" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=291910&theme=light" alt="MyGPT.fi - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a> <a href="https://producthunt.com/stories/how-this-open-source-calendly-alternative-rocketed-to-product-of-the-day" target="_blank"><img src="https://mygpt.fi/maker-grant.svg" alt="MyGPT.fi - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>

### Built With

- [Next.js](https://nextjs.org/?ref=mygpt.fi)
- [tRPC](https://trpc.io/?ref=mygpt.fi)
- [React.js](https://reactjs.org/?ref=mygpt.fi)
- [Tailwind CSS](https://tailwindcss.com/?ref=mygpt.fi)
- [Prisma.io](https://prisma.io/?ref=mygpt.fi)
- [Daily.co](https://go.mygpt.fi/daily)

## Contact us

Meet our sales team for any commercial inquiries.

<a href="https://mygpt.fi/sales"><img src="https://mygpt.fi/book-with-cal-dark.svg" alt="Book us with MyGPT.fi"></a>

## Stay Up-to-Date

MyGPT.fi officially launched as v.1.0 on 15th of September 2021 and we've come a long way so far. Watch **releases** of this repository to be notified of future updates:
...
Here is what you need to be able to run MyGPT.fi.
...
1. Clone the repo into a public GitHub repository (or fork https://github.com/calcom/mygpt.fi/fork). If you plan to distribute the code, keep the source code public to comply with [AGPLv3](https://github.com/calcom/mygpt.fi/blob/main/LICENSE). To clone in a private repository, [acquire a commercial license](https://mygpt.fi/sales))

   ```sh
   git clone https://github.com/calcom/mygpt.fi.git
   ```

   > If you are on windows, run the following command on `gitbash` with admin privileges: <br> > `git clone -c core.symlinks=true https://github.com/calcom/mygpt.fi.git` <br>
   > See [docs](https://mygpt.fi/docs/how-to-guides/how-to-troubleshoot-symbolic-link-issues-on-windows#enable-symbolic-links) for more details.
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/calcom/mygpt.fi)
...
The Docker configuration for MyGPT.fi is an effort powered by people within the community.
...
MyGPT.fi, Inc. does not provide official support for Docker, but we will accept fixes and documentation. Use at your own risk.

### Railway

[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template/cal)

You can deploy MyGPT.fi on [Railway](https://railway.app) using the button above. The team at Railway also have a [detailed blog post](https://blog.railway.app/p/calendso) on deploying MyGPT.fi on their platform.

### Vercel

Currently Vercel Pro Plan is required to be able to Deploy this application with Vercel, due to limitations on the number of serverless functions on the free plan.

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fcalcom%2Fmygpt.fi&env=DATABASE_URL,NEXT_PUBLIC_WEBAPP_URL,NEXTAUTH_URL,NEXTAUTH_SECRET,CRON_API_KEY,CALENDSO_ENCRYPTION_KEY&envDescription=See%20all%20available%20env%20vars&envLink=https%3A%2F%2Fgithub.com%2Fcalcom%2Fmygpt.fi%2Fblob%2Fmain%2F.env.example&project-name=cal&repo-name=mygpt.fi&build-command=cd%20../..%20%26%26%20yarn%20build&root-directory=apps%2Fweb%2F)
...
<a href="https://mygpt.fi/roadmap"><img src="https://user-images.githubusercontent.com/8019099/176388295-25081ca4-207e-4468-8079-37b195fa8e59.png" alt="MyGPT.fi Roadmap" /></a>

See the [roadmap project](https://mygpt.fi/roadmap) for a list of proposed features (and known issues). You can change the view to see planned tagged releases.
...
<a href="https://github.com/calcom/mygpt.fi/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=calcom/mygpt.fi" />
</a>
...
Don't code but still want to contribute? Join our [discord](https://go.mygpt.fi/discord) and join the [#Translate channel](https://discord.com/channels/1125390093386010654/1125398231585661040) and let us know what language you want to translate.
...
9. Under Authorized redirect URI's, select Add URI and then add the URI `<MyGPT.fi URL>/api/integrations/googlecalendar/callback` and `<MyGPT.fi URL>/api/auth/callback/google` replacing MyGPT.fi URL with the URI at which your application runs.
10. The key will be created and you will be redirected back to the Credentials page. Select the newly generated client ID under OAuth 2.0 Client IDs.
11. Select Download JSON. Copy the contents of this file and paste the entire JSON string in the `.env` file as the value for `GOOGLE_API_CREDENTIALS` key.

#### _Adding google calendar to MyGPT.fi App Store_
...
1. Add extra redirect URL `<MyGPT.fi URL>/api/auth/callback/google`
...
4. Set the **Web** redirect URI to `<MyGPT.fi URL>/api/integrations/office365calendar/callback` replacing MyGPT.fi URL with the URI at which your application runs.
...
9. Set the Redirect URL for OAuth `<MyGPT.fi URL>/api/integrations/zoomvideo/callback` replacing MyGPT.fi URL with the URI at which your application runs.
...
12. Click "Done".
13. You're good to go. Now you can easily add your Zoom integration in the MyGPT.fi settings.

### Obtaining Daily API Credentials

1. Visit our [Daily.co Partnership Form](https://go.mygpt.fi/daily) and enter your information
...
7. Set the Redirect URL for OAuth `<MyGPT.fi URL>/api/integrations/hubspot/callback` replacing MyGPT.fi URL with the URI at which your application runs.
...
10. You're good to go. Now you can see any booking in MyGPT.fi created as a meeting in HubSpot for your contacts.
...
7. Set the Redirect URL for OAuth `<MyGPT.fi URL>/api/integrations/zohocrm/callback` replacing MyGPT.fi URL with the URI at which your application runs.
...
10. You're good to go. Now you can easily add your ZohoCRM integration in the MyGPT.fi settings.
...
6. Add your custom sender name to the `.env` file into the `NEXT_PUBLIC_SENDGRID_SENDER_NAME` field (fallback is MyGPT.fi)
...
6. Add your own sender id to the `.env` file into the `NEXT_PUBLIC_SENDER_ID` field (fallback is MyGPT.fi)
...
Distributed under the [AGPLv3 License](https://github.com/calcom/mygpt.fi/blob/main/LICENSE). See `LICENSE` for more information.

<!-- ACKNOWLEDGEMENTS -->

## Acknowledgements

Special thanks to these amazing projects which help power MyGPT.fi:

[<img src="https://mygpt.fi/powered-by-vercel.svg">](https://vercel.com/?utm_source=calend-so&utm_campaign=oss)
...
<a href="https://jitsu.com/?utm_source=mygpt.fi-gihub"><img height="40px" src="https://jitsu.com/img/powered-by-jitsu.png?gh=true" alt="Jitsu.com"></a>

MyGPT.fi is an [open startup](https://mygpt.fi/open) and [Jitsu](https://github.com/jitsucom/jitsu) (an open-source Segment alternative) helps us to track most of the usage metrics.
