...
Contact: [security@mygpt.fi](mailto:security@mygpt.fi)

Based on [https://supabase.com/.well-known/security.txt](https://supabase.com/.well-known/security.txt)

At mygpt.fi, we consider the security of our systems a top priority. But no
...
- E-mail your findings to [security@mygpt.fi](mailto:security@mygpt.fi).
