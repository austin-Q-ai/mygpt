...
<Examples title="Avatar style">
  <Example title="Small">
    <Avatar size="sm" alt="Avatar Story" gravatarFallbackMd5="Ui@MyGPT.fi" />
  </Example>
  <Example title="Large">
    <Avatar size="lg" alt="Avatar Story" gravatarFallbackMd5="Ui@MyGPT.fi" />
  </Example>
</Examples>
...
<Examples title="Avatar Group ">
  <Example title="Small">
    <AvatarGroup
      ...
      items={[
        {
          image: "https://mygpt.fi/stakeholder/peer.jpg",
          alt: "Peer",
          title: "Peer Richelsen",
        },
        {
          image: "https://mygpt.fi/stakeholder/bailey.jpg",
          alt: "Bailey",
          title: "Bailey Pumfleet",
        },
        {
          image: "https://mygpt.fi/stakeholder/alex-van-andel.jpg",
          alt: "Alex",
          title: "Alex Van Andel",
        },
        {
          image: "https://mygpt.fi/stakeholder/ciaran.jpg",
          alt: "Ciarán",
...
<Canvas>
  <Story
    ...
    args={{
      size: "sm",
      alt: "Avatar Story",
      gravatarFallbackMd5: "Ui@MyGPT.fi",
    }}
    argTypes={{
      size: {
        control: {
