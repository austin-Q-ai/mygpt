...
3. Set the Redirect URL for OAuth `<MyGPT.fi URL>/api/integrations/zoho-bigin/callback` replacing MyGPT.fi URL with the URI at which your application runs.
...
7. You're good to go. Now you can easily add Zoho Bigin from the MyGPT.fi app store.
