...
const tabs: VerticalTabItemProps[] = [
  ...
  },
  {
    ...
    children: [
      {
        name: "expertgpt",
        href: "/settings/bots/expertgpt",
        children: [
          { name: "bots", href: "/settings/bots/expertgpt/bots" },
          { name: "upload", href: "/settings/bots/expertgpt/upload" },
          { name: "explore", href: "/settings/bots/expertgpt/explore" },
          { name: "expert_clone", href: "/settings/bots/expertgpt/expert-clone" },
          { name: "settings_bot", href: "/settings/bots/expertgpt/settings" },
        ]
      },
              ...
              <div className="my-3 space-y-0.5">
                {tab.children?.map((child, index) => (
                  <VerticalTabItem
                    ...
                    disableChevron={!child.children ? true : false}
